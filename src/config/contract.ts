...
export const CONTRACT_ABI = [
  ...
  "function verifyDiploma(string calldata _id) external view returns ((string fullName, string birthDate, string title, string mention, uint256 year, string ipfsHash, address institutionAddress, string institutionName, uint256 timestamp, bool exists), bool)",
  "function getInstitution(address _inst) external view returns (string memory name, bool accredited)",
  "function institutions(address) public view returns (string memory name, bool isAccredited)",
